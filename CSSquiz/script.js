const questions = [
...

    {
        ...
        optionA: "style src = example.css",
        optionB: "style src = example.css",
        optionC: "stylesheet example.css stylesheet ",
        optionD: "link rel=stylesheet type=textcss href=example.css ",
...

    {
        ...
        optionA: "background-attachment",
        optionB: "background-image",
        optionC: "background-color",
        optionD: "None of the above",
        correctOption: "optionB"
    },

    {
        ...
        optionA: "p {background-color : yellow;}",
        optionB: "p {background-color : #yellow;}",
        optionC: "all {background-color : yellow;}",
        optionD: "all p {background-color : #yellow;}",
        correctOption: "optionA"
    },
